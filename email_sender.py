...
class EmailSender:
    ...
    def send_report(self, report_content):
        ...
        msg['Subject'] = f"[일간 정책 보고서] {now_kst}"
        ...
        <head>
            <style>
                ...
                h3 {{ color: #2c3e50; font-size: 20px; margin-top: 40px; border-bottom: 2px solid #eee; padding-bottom: 12px; font-weight: 700; }}
        ...
        <body style="margin: 0; padding: 20px 10px; background-color: #f4f7f6; font-family: -apple-system, sans-serif;">
            <div class="container" style="max-width: 800px; margin: auto; background-color: #ffffff; padding: 40px; border-radius: 12px; text-align: left !important;">
                <h1 style="color: #1a2a6c; text-align: center; margin-bottom: 40px;">일간 정책 보고서</h1>
                <div class="report-body" style="text-align: left !important;">
                    {html_report}
                </div>
                <div class="footer" style="text-align: center !important;">
                    <div>본 보고서는 고도의 AI 분석 기술을 통해 이소희 의원실 보좌용으로 생성되었습니다.</div>
                    <div class="disclaimer">© 2026 Lee So-hee Office. All rights reserved.</div>
                </div>
            </div>
        </body>
        </html>
